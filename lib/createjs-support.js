...
(function (alm) {
    var AnimateUtil = (function () {
        ...
        AnimateUtil.getChildren = function (parent) {
            var children = [];
            var tweens = parent["timeline"]["_tweens"];
        ...
        AnimateUtil.getMovieClipsFromStateList = function (stateList) {
            if (stateList) {
                var clips = [];
                var numClips = stateList.length;
...
(function (alm) {
    ...
    KeyWatcherEvent.KEY_LONG_PRESS = "keyLongPress";
