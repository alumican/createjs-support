    ...
    var Logger = (function () {
        ...
        Logger.verbose = function () {
            ...
            if (Logger.level <= LoggerLevel.Verbose)
                console.log.apply(console, Array.prototype.slice.call(["Verbose: "].concat(messages)));
        };
        ...
        Logger.warn = function () {
            ...
            if (Logger.level <= LoggerLevel.Warn)
                console.log.apply(console, Array.prototype.slice.call(["Warn: "].concat(messages)));
        };
        Logger.error = function () {
            ...
            if (Logger.level <= LoggerLevel.Error)
                console.log.apply(console, Array.prototype.slice.call(["Error: "].concat(messages)));
        };
