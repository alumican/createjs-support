...
(function (alm) {
    ...
    Num.PI_4 = Num.PI / 4;
    Num.PI_6 = Num.PI / 6;
    Num.RAD2DEG = 180 / Num.PI;
    Num.DEG2RAD = Num.PI / 180;
    alm.Num = Num;
})(alm || (alm = {}));
var alm;
(function (alm) {
    var CommandUtil = (function () {
        ...
        CommandUtil.fadeTo = function (target, opacity, duration, easing, execute) {
        ...
        CommandUtil.fadeIn = function (target, duration, easing, execute) {
            if (execute === void 0) { execute = true; }
            return CommandUtil.fadeTo(target, 1, duration, easing, execute);
        };
        CommandUtil.fadeOut = function (target, duration, easing, execute) {
            if (execute === void 0) { execute = true; }
...
(function (alm) {
    var AssetLoader = (function () {
        ...
        AssetLoader.getAnimateManifest = function (basePath) {
            ...
            var manifest = window["lib"]["properties"]["manifest"];
            if (basePath != "") {
